...
\begin{quotation}[Activista y estadista]{Nelson Mandela (1918--2013)}
...
\item \textbf{Menciones en comentarios más estándar.} El sistema de menciones actual funciona a través del botón \textit{Responder}, que rellena la mención usando el correo electrónico del usuario entre corchetes. Aunque cumple su función, resulta poco natural comparado con el \texttt{@usuario} habitual en otras redes sociales. Una futura iteración podría implementar un autocompletado al escribir \texttt{@} que sugiera usuarios por nombre y los vincule directamente a su perfil.
