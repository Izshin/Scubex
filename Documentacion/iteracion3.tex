...
Adicionalmente, se han implementado tests de controlador (\texttt{PublicationControllerTest}) que verifican el listado, creación, edición y borrado de publicaciones, así como el control de autorización (403 al intentar borrar una publicación ajena). Por lo mismo que en iteraciones anteriores, no se detallan aquí.
